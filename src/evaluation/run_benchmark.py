...
DATASETS = {
    "chebi": {
        ...
        "ontology_dir": DATA_DIR / "chebi",
        "ontology_config": {
            'path': DATA_DIR / "ontologies" / "chebi.owl",
            'prefix': 'CHEBI:',
            'id_pattern': r'^(CHEBI):\d+',
            'dump_json_path': DATA_DIR / "chebi" / "ontology_dump.json",
            'enriched_docs_path': DATA_DIR / "chebi" / "enriched_documents.json",
            'embeddings_path': DATA_DIR / "chebi" / "embeddings.json",
            'whoosh_index_dir': DATA_DIR / "chebi" / "whoosh_index",
            'faiss_index_path': DATA_DIR / "chebi" / "faiss_index.bin",
            'faiss_metadata_path': DATA_DIR / "chebi" / "faiss_metadata.json",
        },
        "prompts": {
